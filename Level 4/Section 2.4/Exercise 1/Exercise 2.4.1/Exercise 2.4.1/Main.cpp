//Exercise 2.4.1 asks us to build onto exercise 2.3.7 by adding operators to our point, line, and circle classes
...
int main()
{
	...
	//Testing the assignment operator, should print the same coordinates as the second point but using the first point
