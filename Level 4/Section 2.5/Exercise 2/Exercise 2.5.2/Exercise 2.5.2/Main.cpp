//Exercise 2.5.2 asks us to build onto exercise 2.5.1 by performing the following steps:
//Create an array of Point pointers with 3 elements on the heap, Create for each element in the array a point on the heap, Iterate the array and print each point in the array, Iterate the array again and delete each point in the array, Delete the array itself.
