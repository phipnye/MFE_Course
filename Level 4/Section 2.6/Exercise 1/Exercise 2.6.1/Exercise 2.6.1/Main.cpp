//Exercise 2.6.1 asks us to build onto exercise 2.5.3 by putting all of our classes into a namespace that's divided into CAD and Containers
...
namespace Circle = PhilipNye::CAD;		//Using the Circle class by creating a shorter alias for the YourName::CAD namespace
...
int main()
{
	...
	PhilipNye::CAD::Circle c_0(p_0, l_0);			//Declaring and initializing a cirlce with p_0 as its center and l_0 as its radius
