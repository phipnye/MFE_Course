//Exercise 4.2.5 asks us to build onto exercise 4.2.4 by adding a StackException Base Class with StackFullException and StackEmptyException derived classes so that the internal use of array is unknown to user
