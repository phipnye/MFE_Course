//Exercise 4.2.1.b asks us to build onto exercise 4.2.1.a by adding a static variable in the Array class that indicates the default array size when using the default constructor
