//Exercise 2.3.2 asks us to alter the program made in 2.3.1 and change the distance function so that it passes the input point “by reference” instead, so that no copy is made.
