...
public:
	...
	Line(Point& P1, Point& P2);		//Constructor with a start - and end - point.
	Line(const Line& L);			//Copy constructor

	Point Start_p() const;				//Overloaded getter for the start-point.
	Point End_p() const;				//Overloaded getter for the end-point.

	void Start_p(const Point& start_p);	//Overloaded setter for the start-point
	void End_p(const Point& end_p);		//Overloaded setter for the end-point
