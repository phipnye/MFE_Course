//PerpAmericanOption.hpp is a header file that declares the class for Perpetural American options,
//which is a class that represents solutions to Perpetual American options.
